...
(cl:defmethod cl:initialize-instance :after ((m <drive_param>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'drive_param)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name racecar-msg:<drive_param> is deprecated: use racecar-msg:drive_param instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <drive_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader racecar-msg:velocity-val is deprecated.  Use racecar-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <drive_param>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader racecar-msg:angle-val is deprecated.  Use racecar-msg:angle instead.")
  (angle m))
