...
#		flag_obstacle = 1
	...
	#error_left, curr_dist_left = followLeft(data,-0.1)#followLeft(data,1.) Extra line by dieman95
	error_left, curr_dist_left = followRight(data,0.05)#followLeft(data,1.) Commented out by dieman95
